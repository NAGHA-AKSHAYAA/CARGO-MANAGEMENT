...
<body>
	...
	<?php
	$condition	=	'';
	if(isset($_REQUEST['username1']) and $_REQUEST['username1']!=""){
		$condition	.=	' AND first_name LIKE "%'.$_REQUEST['username1'].'%" ';
	}
	if(isset($_REQUEST['username2']) and $_REQUEST['username2']!=""){
		$condition	.=	' AND last_name LIKE "%'.$_REQUEST['username2'].'%" ';
	}
	if(isset($_REQUEST['useremail']) and $_REQUEST['useremail']!=""){
		$condition	.=	' AND email LIKE "%'.$_REQUEST['useremail'].'%" ';
	}
	if(isset($_REQUEST['userpass']) and $_REQUEST['userpass']!=""){
		$condition	.=	' AND password LIKE "%'.$_REQUEST['userpass'].'%" ';
	}
	if(isset($_REQUEST['userphone']) and $_REQUEST['userphone']!=""){
		$condition	.=	' AND phone_number LIKE "%'.$_REQUEST['userphone'].'%" ';
	}
						...
						<div class="row">
							<div class="col-sm-2">
								<div class="form-group">
									...
									<input type="text" name="username1" id="username1" class="form-control" value="<?php echo isset($_REQUEST['username1'])?$_REQUEST['']:''?>" placeholder="Enter user name">
								</div>
							</div>
							<div class="col-sm-2">
								<div class="form-group">
